...
import com.example.bookcomposeapp.view.BookDetailsScreen
import com.example.bookcomposeapp.view.BookListScreen
...
fun NavGraph() {
    ...
    NavHost(navController, startDestination = Screens.BookList.route) {
        // Home
...
class MainActions(navController: NavController) {
    ...
    val gotoBookDetails: (String) -> Unit = { isbnNo ->
        navController.navigate("${Screens.Details.route}/$isbnNo")
    }
