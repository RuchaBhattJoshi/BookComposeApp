package com.example.bookcomposeapp.view
...
import com.example.bookcomposeapp.components.BookDetailCard
import com.example.bookcomposeapp.components.TopBar
import com.example.bookcomposeapp.navigation.MainActions
import com.example.bookcomposeapp.utils.DetailState
import com.example.bookcomposeapp.viewmodel.MainViewModel
...
fun BookDetails(viewModel: MainViewModel) {
    when (val result = viewModel.bookDetails.value) {
        DetailState.Loading -> Text(text = "Loading")
        is DetailState.Error -> Text(text = "Error found: ${result.exception}")
        ...
        DetailState.Empty -> Text("No results found!")
    }
}