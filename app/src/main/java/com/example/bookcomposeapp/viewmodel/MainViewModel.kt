package com.example.bookcomposeapp.viewmodel
...
import com.example.bookcomposeapp.utils.ViewState
...
class MainViewModel : ViewModel() {
    ...
    private val _detailViewState = MutableStateFlow<DetailState>(DetailState.Loading)
    ...
    fun getBookByID(context: Context, isbnNO:String) = viewModelScope.launch {
        try {
            ...
            _detailViewState.value = DetailState.Success(bookList)

        } catch (e: Exception){
            _detailViewState.value = DetailState.Error(e)
        }
    }
